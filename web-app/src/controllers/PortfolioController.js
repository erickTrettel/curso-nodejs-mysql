...
class PortfolioController {
        ...
        if (response.erro) {
          ...
          for (const servico of response.dados) {
            dados += `<tr>
                            ...
                            <td><button type="button" class="btn btn-primary btn-editar" data-id="${
                              servico.id_portfolio
                            }">Editar</button></td>
                            <td><button type="button" class="btn btn-primary btn-excluir" data-id="${
                              servico.id_portfolio
                            }">Excluir</button></td>
                        </tr>`;
          }
  ...
  registrarEvents() {
    document
      .getElementById("btn-exibir-formulario")
    ...
    document
      .getElementById("btn-cadastrar-portfolio")
      .addEventListener("click", function() {
    ...
    document
      .getElementById("btn-cancelar-operacao")
      .addEventListener("click", function() {
        objPortfolioController.limparMsgAlert();
        objPortfolioController.limparCamposForm(formulario);
        objPortfolioController.ocultarElemento("formulario");
